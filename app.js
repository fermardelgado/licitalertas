...
async function abrirFicha(id) {
  ...
  body.innerHTML = `
    ...
    <div class="ficha-datos">
      ...
      <div><div class="ficha-dato-lbl">Vence</div><div class="ficha-dato-val">${c.fecha_vencimiento || "—"} (${badgeUrg(c.urg, c.dias)})</div></div>
...
function mkChart(id, type, labels, data, colors, opts={}) {
  ...
  charts[id] = new Chart(canvas, {
    type, data: { labels, datasets: [{ data, backgroundColor: colors, borderRadius: type==="bar"?6:0 }] },
